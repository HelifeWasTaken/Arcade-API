...
namespace arcade
{
    ...
    class ICore
    {
      public:
        ...
        /**
         * @brief Load a new Display/DisplayEngine (throw an exception if the (D/E)
         * could not be loaded) The (D/E) should be destroyed with inside the
         * IDLLoader before loading a new one
         * Should throw a standard arcade::Error in case of problem while
         * loading the library
         *
         */
        ...
        /**
         * @brief Run the base loop for every game (So that the game DisplayEngine
         * loop is generic) (This function should be called only if the Game
         * and DisplayEngine are loaded) otherwise a standard arcade::Error will be
         * thrown
         *
         */
        virtual void run() = 0;
